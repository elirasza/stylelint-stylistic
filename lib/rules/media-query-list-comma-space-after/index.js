...
const ruleName = 'stylistic/media-query-list-comma-space-after'
...
const meta = {
  url: 'https://github.com/elirasza/stylelint-stylistic/tree/main/lib/rules/media-query-list-comma-space-after',
  fixable: true,
}
