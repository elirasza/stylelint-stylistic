...
const ruleName = 'stylistic/selector-list-comma-newline-before'
...
const meta = {
  url: 'https://github.com/elirasza/stylelint-stylistic/tree/main/lib/rules/selector-list-comma-newline-before',
  fixable: true,
}
      ...
      for (const [ruleNode, commaIndices] of fixData.entries()) {
        ...
        for (const index of commaIndices.sort((a, b) => b - a)) {
          ...
          if (primary.startsWith('always')) {
            ...
            if (spaceIndex >= 0) {
              beforeSelector = beforeSelector.slice(0, spaceIndex)
                + context.newline
