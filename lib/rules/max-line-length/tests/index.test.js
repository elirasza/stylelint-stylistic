...
const whitespaces = Array.from({ length: 21 }).fill('\u0020').join('')
...
testRule({
  ...
  accept: [
    ...
    {
      code: `a {\n background-image:\nurl(\n${whitespaces.slice(0, 20)}"${testUrl}"\n); }`,
      description: 'exactly 20 whitespaces',
    },
    {
      code: `a {\n background-image:\nurl(\n"${testUrl}"${whitespaces.slice(0, 20)}\n); }`,
      description: 'exactly 20 whitespaces',
    },
  ],
  ...
  reject: [
    ...
    {
      code: `@import '${testUrl}';\na {\n background: url("${testUrl}"${whitespaces});\n}`,
      warnings: [
        {
          message: messages.expected(20),
          line: 3,
    ...
    {
      code: `@import url("${testUrl}"${whitespaces});`,
      warnings: [
        {
          message: messages.expected(20),
          line: 1,
    ...
    {
      code: `@import '${testUrl}'${whitespaces};\na {\n background: url("${testUrl}"${whitespaces});\n}`,
      warnings: [
        {
          message: messages.expected(20),
          line: 1,
